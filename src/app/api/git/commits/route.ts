...
export async function GET() {
  try {
    ...
    const GITHUB_REPO = process.env.GITHUB_REPO || 'location-news'
    ...
    const mockCommits = [
      {
        ...
        url: 'https://github.com/yourusername/location-news/commit/a1b2c3d4e5f6'
      },
      {
        sha: 'b2c3d4e5f6g7',
        ...
        url: 'https://github.com/yourusername/location-news/commit/b2c3d4e5f6g7'
      },
      {
        sha: 'c3d4e5f6g7h8',
        ...
        url: 'https://github.com/yourusername/location-news/commit/c3d4e5f6g7h8'
      },
      {
        sha: 'd4e5f6g7h8i9',
        ...
        url: 'https://github.com/yourusername/location-news/commit/d4e5f6g7h8i9'
      },
      {
        sha: 'e5f6g7h8i9j0',
        ...
        url: 'https://github.com/yourusername/location-news/commit/e5f6g7h8i9j0'
      },
      {
        sha: 'f6g7h8i9j0k1',
        ...
        url: 'https://github.com/yourusername/location-news/commit/f6g7h8i9j0k1'
      }
    ]
